...
%
CROCO_title  = 'SCS Model';
CROCO_config = 'SCS Model';
%
% Grid dimensions:
%
%etop1: -25~50N  90E-180
lonmin =  105;   % Minimum longitude [degree east]
lonmax =  115;   % Maximum longitude [degree east]
latmin =   14.5;   % Minimum latitudeF  [degree north]
...
bioname  = [CROCO_files_dir,'roms_frcbio.nc']; % Iron Dust forcing for PISCES
rivname =  [CROCO_files_dir,'roms_runoff.nc'];
%
...
%   monthly climatology 
%
woa_time=(15:30:365); % days: middle of each month
...
%
tini=datenum(Ymin,Mmin,Dmin)-datenum('1980-01-01');
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
FRCST_dir = [FORC_DATA_DIR,'HYCOM/'];  % path to local OGCM data directory
%
