...
varcheck('ROMSnames',{'M2','S2','N2','K2','K1','O1','P1','Q1','M4','MN4','MS4','2N2'});
...
TPXOfile.grid='E:\croco_tools\DATA\TPXO9\grid_tpxo9_wp.nc';
TPXOfile.elev='E:\croco_tools\DATA\TPXO9\h_k1_tpxo9_wp_30.nc';
TPXOfile.vel='E:\croco_tools\DATA\TPXO9\u_k1_tpxo9_wp_30.nc';
...
nx=1203;    ny=902;
X=repmat(ncread(TPXOfile.grid,'lon_z')',nx,1);
Y=repmat(ncread(TPXOfile.grid,'lat_z'),1,ny);
...
X=repmat(ncread(TPXOfile.grid,'lon_u')',nx,1);
Y=repmat(ncread(TPXOfile.grid,'lat_u'), 1,ny);
...
X=repmat(ncread(TPXOfile.grid,'lon_v')',nx,1);
Y=repmat(ncread(TPXOfile.grid,'lat_v'), 1,ny);
